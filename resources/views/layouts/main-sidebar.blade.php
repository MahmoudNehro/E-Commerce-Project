        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('roles.create') }}">
                                ...
                                <span class="menu-title">{{ trans('roles.Create_role') }}</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            ...
                            <a class="menu-link" href="{{ route('permissions.index') }}">
                                ...
                                <span class="menu-title">{{ trans('roles.Permissions') }}</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('permissions.create') }}">
                                ...
                                <span class="menu-title">{{ trans('roles.Create_permission') }}</span>
                            </a>
                        </div>
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link" href="{{ route('contact-us.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
